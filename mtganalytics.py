...
if len(sys.argv) == 3 and sys.argv[1] == 'fetchcards':
    ...
    print('    python mtganalytics.py fetchcards cards.json')
    print('')
    print('Fetch card ratings from Gatherer:')
    print('    python mtganalytics.py fetchratings data/cards.json data/ratings.json')
    print('')
    print('Analyze card types relative to ratings:')
    print('    python mtganalytics.py analyzetypes data/ratings.json')
